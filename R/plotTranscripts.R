...
# plotTranscripts
#-----------------------------------------------------------------------------------------------
plotTranscripts <- function(tr, gr, chrom=NA, strand=NA, scale=TRUE, runGenes="best", brokenAnnotation="best", first=NA, last=NA, filename=NA) {
	if (!is.na(chrom)) {
